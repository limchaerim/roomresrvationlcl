<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="RsvId" v-model="value.rsvId" :editMode="editMode" :inputUI="''"/>
            <Number label="Amount" v-model="value.amount" :editMode="editMode" :inputUI="''"/>
            <Date label="PaymentDt" v-model="value.paymentDt" :editMode="editMode" :inputUI="''"/>
