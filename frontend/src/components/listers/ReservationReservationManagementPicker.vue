...
<script>
    ...
    export default {
        name: 'ReservationReservationManagementPicker',
        props: {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.reservationManagements;
            }

            if(me.value && typeof me.value == "object" && Object.values(me.value)[0]) {
                var id = Object.values(me.value)[0];
                var tmpValue = await axios.get(axios.fixUrl('/reservationManagements/' + id))
                if(tmpValue.data) {
